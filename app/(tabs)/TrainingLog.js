...
export default function TrainingLog() {
  ...
  const handleWeightChange = (exerciseId, setIndex, value) => {
    setWeights(prev => ({
      ...prev,
      [exerciseId]: prev[exerciseId].map((w, i) => i === setIndex ? value : w),
    }));
  };
...
const styles = StyleSheet.create({
  ...
  dateText: { paddingHorizontal: 16, marginBottom: 16, color: '#6B7280', fontSize: 16 },
  scrollContent: { paddingHorizontal: 16 },
  exerciseCard: { backgroundColor: 'white', borderRadius: 12, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#E5E7EB' },
  ...
  submitButton: { backgroundColor: '#22C55E', padding: 16, borderRadius: 12, alignItems: 'center', marginVertical: 16 },
